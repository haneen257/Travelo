  ...
  <header>
    <nav class="navbar">
        ...
        <div>
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link " onclick="document.location.href=' Day Use.php'">Day use</a>
                </li>
                <li class="nav-item">
    ...
    <section class="important-trip">
        ...
        <div class="box">
          ...
          <button class="btn-click" onclick="document.location.href='day use page/Pharaonic Village/Pharaonic Village.html'">More</button>
        </div>
        <div class="box">
          ...
          <button class="btn-click" onclick="document.location.href='day use page/Romance Hotel/Romance Hotel.html'">More</button>
        </div>
        <div class="box">
          ...
          <button class="btn-click" onclick="document.location.href='day use page/Swiss Inn Dome Marine/Swiss Inn Dome Marine.html'">More</button>
        </div>
        <div class="box">
          ...
          <button class="btn-click" onclick="document.location.href='day use page/Rayyan Valley Fayoum/Rayyan Valley Fayoum.html'">More</button>
        </div>
    </section>
