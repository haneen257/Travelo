  ...
  <header>
            ...
            <div class="d-flex justify-content-between h-100">
                ...
                <div class="list_reservations col-5 d-flex align-items-center">
                    <nav class="h-75">
                        ...
                        <!-- <li><i class="fas fa-dot-circle"></i><?php print_r($_SESSION['location']); ?> </li> -->
    ...
    <section class="important-trip">
      ...
      <div class="box">
       ...
       <button class="btn-click" onclick="document.location.href='home/Luxor/homeLuxor.html'">More</button>
      </div>
      <div class="box">
        ...
        <button class="btn-click" onclick="document.location.href='home/Aswan/homeAswan.html'">More</button>
      </div>
      <div class="box">
        ...
        <button class="btn-click" onclick="document.location.href='home/Hurghada/homeHurghada.html'">More</button>
      </div>
      <div class="box">
        ...
        <button class="btn-click" onclick="document.location.href='home/Dahab/homeDahab.html'">More</button>      </div>
      <div class="box">
        ...
        <button class="btn-click" onclick="document.location.href='home/Sharm El-Shaikh/homeSharm El-Shaikh.html'">More</button>      </div>
      <div class="box">
        ...
        <button class="btn-click" onclick="document.location.href='home/North Coast/homeNorth Coast.html'">More</button>      </div>
